...
class RolePermissionSeeder extends Seeder
{
    ...
    protected function permissionNames(): array
    {
        return [
            ...
            'variation_templates.index',
            'variation_templates.create',
            'variation_templates.edit',
            'variation_templates.delete',

            'rack_locations.index',
            'rack_locations.create',
            'rack_locations.edit',
            'rack_locations.delete',

            'warehouse_product_settings.index',
            'warehouse_product_settings.create',
            'warehouse_product_settings.edit',
            'warehouse_product_settings.delete',
