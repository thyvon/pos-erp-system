const sales = {
  ...
  form: {
    ...
    duplicateSerial: 'Serial {{serial}} is already used on another sale line.',
    duplicateSerialAlert: 'One or more serial numbers are duplicated. Select each serial only once.',
    duplicateSerialSubmitBlocked: 'Some sale lines use the same serial number.',
    outOfStock: '{{product}} is not available in the selected warehouse.',
