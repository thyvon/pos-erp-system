...
import type { PurchasePayment, PurchasePaymentCorrectionPayload, PurchasePaymentMethod } from '@/types/purchase'
...
interface PurchasePaymentCorrectionDialogProps {
  open: boolean
  ...
  isSaving: boolean
  onClose: () => void
  onSubmit: (payload: PurchasePaymentCorrectionPayload) => Promise<void>
}
...
function valuesFromPayment(payment: PurchasePayment | null, paymentAccounts: PaymentAccount[]): FormInput {
...
export function PurchasePaymentCorrectionDialog({
  open,
  payment,
  paymentAccounts,
  defaultExchangeRate,
  ...
  onClose,
  onSubmit,
}: PurchasePaymentCorrectionDialogProps) {
