<template>
  <section class="erp-table-shell relative z-10 overflow-visible rounded-[20px]">
    <button
      type="button"
      class="flex w-full items-center justify-between gap-3 px-3.5 py-2.5 text-left transition hover:bg-white/10 dark:hover:bg-white/[0.06]"
    ...
    >
      ...
      >
        <div class="erp-filter-panel-body rounded-b-[20px] border-t border-white/40 px-3.5 py-3 dark:border-white/10">
          <slot />
        </div>
      </div>
    </Transition>
