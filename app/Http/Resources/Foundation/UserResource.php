...
class UserResource extends JsonResource
{
    ...
    {
        $this->loadMissing(['business', 'roles', 'permissions', 'branches', 'defaultBranch', 'warehouses', 'defaultWarehouse']);
        ...
        return [
            ...
            'warehouses' => $this->warehouses->map(fn ($warehouse) => [
                'id' => $warehouse->id,
                'name' => $warehouse->name,
                'code' => $warehouse->code,
            ...
            'warehouse_ids' => $this->warehouses->modelKeys(),
