...
return static function (): void {
    ...
    Route::post('sales/{sale}/with-payments', [SaleController::class, 'updateWithPayments'])->middleware('can:update,sale');
    ...
    Route::get('cash-registers/{cashRegister}/session-report', [CashRegisterController::class, 'currentSessionReport'])->middleware('can:closeSession,cashRegister');
